...
export function Header() {
  ...
  function HandleToggleMenu() {
    ...
    toggleThemeIcon.classList.contains("darkIcontoggle")
      ? toggleThemeIcon.classList.remove("darkIcontoggle")
      : toggleThemeIcon.classList.add("darkIcontoggle");
          ...
          <nav className="container">
            ...
            <div className="menu">
              <ul className="grid">
                ...
                <li>
                  <a
                    className="title title_toggle sobre_menu"
                    href="/#about"
                    alt=""
                    onClick={handleCloseMenu}
                    name="about"
